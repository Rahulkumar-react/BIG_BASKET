...
import ReviewBackground from "../Pages/Assets/ReviewBackground.png";
        ...
        <Box sx={{ mt: 5 }}>
          ...
          >
            ...
            <Grid
              ...
              sx={{
                width: "70%",
                border: { sm: "none", sm: "1px solid #eeeeee" },
              }}
            >
              <Images src={ProductImage} alt="" />
            </Grid>
            ...
            <Grid xs={12} md={7} lg={5}>
              <Box>
                ...
                <Paragraph>
                  Fresho Neem Leaves - Organically Grown, 50 g
                </Paragraph>
          ...
          <Grid>
            ...
            <Grid container spacing={2} marginY={5}>
              ...
              >
                ...
                >
                  <Grid sx={{ marginY: 2, textAlign: "center" }}>
              ...
              <Box>
                ...
                <ProInfo>
                  {!isActive1 ? (
                    ...
                    <>
                      Neem is a normal herb that has many good looks benefits.
                      Its extracts have been used in the Ayurvedic tradition for
                      thousands of years for maintaining fitness and overall
                      well-being. Neem leaves & flowers are measured safe to
                      take internally on a regular or daily basis. Product image
                      shown is for representation purpose only, the actually
                      product may vary based on season, produce & availability.
                    </>
                  )}
                </ProInfo>
              </Box>
                  ...
                  <ul>
                    {!isActive2 ? (
                      ...
                      <>
                        ...
                        <li>
                          It also relieves dryness and itching, strengthens hair
                          and promotes hair growth.
                        </li>
                        <li>
                          It also soothes irritation, prevents dryness and
                          flaking.
                        </li>
                      </>
                    )}
                ...
                <ProInfo>
                  {!isActive3 ? (
                    ...
                    <>
                      ...
                      purposes only. Please refer to the information provided on
                      the product package received at delivery for the actual
                      expiry date.
                      <br />
                      For Queries/Feedback/Complaints, Contact our Customer Care
                      Executive at: Phone: 1860 123 1000 | Address: Innovative
                      Retail Concepts Private Limited, Ranka Junction 4th Floor,
                      Tin Factory bus stop. KR Puram, Bangalore - 560016
          ...
          <Grid sx={{ paddingY: 3 }}>
            <Typography
              sx={{ fontSize: "18px", fontWeight: 700, marginBottom: 1 }}
            >
              Rating and Reviews
            </Typography>
            <Box
            ...
            >
              ...
              <Typography sx={{ fontSize: "16px" }}>
                You can rate or review this product only after
                <br /> purchasing from bigbasket
              </Typography>
            </Box>
          </Grid>
        </Box>
